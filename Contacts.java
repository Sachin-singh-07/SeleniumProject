...
//		Click on contacts
		...
		Thread.sleep(2000);
		String CONTACTFIRST = eutil.getDataFromExcel("Contact", 0, 1);
		String CONTACTLAST = eutil.getDataFromExcel("Contact", 1, 1);
		String CONGROUP = eutil.getDataFromExcel("Contact", 2, 1);
...
//		WebElement notificheckbox = driver.findElement(By.name("notify_owner"));
